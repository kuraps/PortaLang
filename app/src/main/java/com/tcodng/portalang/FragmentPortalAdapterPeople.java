...
public class FragmentPortalAdapterPeople extends RecyclerView.Adapter<FragmentPortalAdapterPeople.MyViewHolder> {
    DatabaseReference reference3;
    Context context;
    ArrayList<FragmentPortalModelPeople> modelPeople;

    public FragmentPortalAdapterPeople(Context context, ArrayList<FragmentPortalModelPeople> modelPeople){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_portal_people, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        final String missing_ppl_tipe = modelPeople.get(position).getMissing_ppl_type();
        if(missing_ppl_tipe.equals("Missing People")){
            holder.xmissing_people_type.setText(context.getString(R.string.miss));
        }else {
            // TIKETS = tiket lebih dari 1
            holder.xmissing_people_type.setText(context.getString(R.string.found));
        }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder{
        TextView xmissing_people_name, xmissing_people_characteristic, xmissing_people_address,xmissing_people_type;
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            xmissing_people_type = itemView.findViewById(R.id.missing_people_type);
        }
    }
}